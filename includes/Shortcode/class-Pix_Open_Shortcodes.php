...
class Pix_Open_Shortcodes {
	...
	function add_current_status_shortcode( $atts ) {
		...
		ob_start();
		?>
		<div id=<?php echo $open_note_id ?> class="opening-hours__open-note"><?php echo esc_attr( $open_note ); ?></div>
		<div id=<?php echo $close_note_id ?> class="opening-hours__closed-note"><?php echo esc_attr( $closed_note ); ?></div>
		<?php
